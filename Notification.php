...
public function fetch_notifications() {
    ...
    $this->db->select('id, userId, message, taskId, supportMeetingId,classfeeId,studentkitId,transId,assmentId, standardimagesId,standId,branchesId,internaldesignid,dcfeetempId, assetsId, credId,dailyreportId,followupId, empofmonthsId, festiveimagesId, brimgvideoId,coupnsId,proddefectiveId,amtconfId,attachmentId,dmfranchsehoId ,clientId, announcementId,blogId,pdcId,customDesignId,despatchId,acattachmentId,lgattachmentId,leaveId ,faqId,brsetupid,admid,stockId,freegiftId,socialId,staffId,onboardfrmId,amcId,locationApprovalId,adminMeetingId,approvalId ,trainingId,ticketId,dmfranchseId,referenceId,qcId,hreventId');
...
public function all_notifications()
{
    ...
    $this->db->select('id, userId, message, taskId, approvalId ,transId,assmentId, standardimagesId,standId, internaldesignid,classfeeId,dcfeetempId,studentkitId, supportMeetingId,assetsId, followupId,brimgvideoId,dailyreportId,empofmonthsId, festiveimagesId,credId, coupnsId,proddefectiveId, branchesId,amtconfId,announcementId,dmfranchsehoId,clientId, blogId, pdcId, customDesignId, despatchId, acattachmentId, lgattachmentId, leaveId, faqId, brsetupid, admid, stockId, freegiftId, socialId, staffId, onboardfrmId, amcId, locationApprovalId, adminMeetingId, trainingId, is_read, created_at,ticketId,dmfranchseId,referenceId,qcId,hreventId');
    $this->db->where('userId', $userId);
    $this->db->order_by('created_at', 'DESC');
    $query = $this->db->get('tbl_notifications');
