 ...
 * Account Class to control task related operations.
 * @author : Ashish
 * @version : 1.0
 * @since : 08 Jun 2023
  */
class Account extends BaseController
{
    ...
    {
        redirect('account/accountListing');
    }
    ...
    function accountListing()
    {
        ...
        {        
            ...
            $count = $this->ac->despatchListingCount($searchText);

			$returns = $this->paginationCompress ( "accountListing/", $count, 500 );
            
            $data['records'] = $this->ac->despatchListing($searchText, $returns["page"], $returns["segment"]);
            
            $this->global['pageTitle'] = 'CodeInsect : Account';
    ...
    function edit($despatchId = NULL)
    {
        ...
        else
        {
            ...
            $data['despatchInfo'] = $this->ac->getDespatchInfo($despatchId);
            $data['branchDetail'] = $this->bm->getBranchesFranchiseNumber();
            $data['users'] = $this->dm->getUser();
    ...
    function editAccount()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $result = $this->ac->editDespatch($despatchInfo, $despatchId);
