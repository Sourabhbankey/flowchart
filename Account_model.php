...
class Account_model extends CI_Model
{
    ...
    {
        $this->db->trans_start();
        $this->db->insert('tbl_account', $accountInfo);
     ...
     */
    function getDespatchInfo($accountId)
    {
        $this->db->select('accountId, accountTitle, description, franchiseNumber, orderNumber, modeOforder, transportCourior, emailconfirmDispatchPOD, podNumber,');
