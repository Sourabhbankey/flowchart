...
class Login_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.password, BaseTbl.name, BaseTbl.roleId,BaseTbl.isAdmin, BaseTbl.franchiseNumber,Roles.role, Roles.status as roleStatus, Roles.isDeleted as isRoleDeleted');
