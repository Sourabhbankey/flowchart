...
class Branches extends BaseController
{
    ...
    function branchesListing()
    {
        ...
        else
        {
            ...
            $count = $this->bm->branchesListingCount($searchText, $role, $userId);

            $returns = $this->paginationCompress ( "branchesListing/", $count, 1000 );
            
            $data['records'] = $this->bm->branchesListing($searchText, $returns["page"], $returns["segment"], $role, $userId);
            
            $this->global['pageTitle'] = 'CodeInsect : Branches';
    ...
    function editBranches()
    {
        ...
        else
        {
            ...
            {
                /*---Start Legal Documets--*/
                $legalDocs = $this->input->post('access');
                ...
                $updated = $this->bm->updateLegalDocuments($branchesId, $accessMatrix);
                /*---End Legal Documets--*/
                ...
                //$branchesInfo = array('applicantName'=>$applicantName, 'address'=>$address, 'updatedBy'=>$this->vendorId, 'updatedDtm'=>date('Y-m-d H:i:s'));
                $branchesInfo = [];
                ...
                if(!empty($adminTraining)){
                    $branchesInfo['adminTraining']=$adminTraining;
                }
